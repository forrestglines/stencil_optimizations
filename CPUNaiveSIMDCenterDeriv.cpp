...
template<typename T>
void CPUNaiveSIMDCenterDeriv3p_x(T *u, T *out, int nx, int ny, int nz){
...
template<typename T>
void CPUNaiveSIMDCenterDeriv3p_y(T *u, T *out, int nx, int ny, int nz){
...
template<typename T>
void CPUNaiveSIMDCenterDeriv3p_z(T *u, T *out, int nx, int ny, int nz){
...
template<typename T>
void CPUNaiveSIMDCenterDeriv7p_x(T *u, T *out, int nx, int ny, int nz){
...
template<typename T>
void CPUNaiveSIMDCenterDeriv7p_y(T *u, T *out, int nx, int ny, int nz){
...
template<typename T>
void CPUNaiveSIMDCenterDeriv7p_z(T *u, T *out, int nx, int ny, int nz){
...
void CPUCenterDeriv<T>::CPUNaiveSIMDCenterDeriv(int dim){
  switch (stencil_size_){
    case 3:
      switch(dim){
        case 0:
          CPUNaiveSIMDCenterDeriv3p_x(u_,u2_,nx_,ny_,nz_);
          break;
        case 1:
          CPUNaiveSIMDCenterDeriv3p_y(u_,u2_,nx_,ny_,nz_);
          break;
        case 2:
          CPUNaiveSIMDCenterDeriv3p_y(u_,u2_,nx_,ny_,nz_);
          break;
        case 3:
          CPUNaiveSIMDCenterDeriv3p_x(u_,u2_,nx_,ny_,nz_);
          CPUNaiveSIMDCenterDeriv3p_y(u_,u2_,nx_,ny_,nz_);
          CPUNaiveSIMDCenterDeriv3p_z(u_,u2_,nx_,ny_,nz_);
          break;
        default:
          std::stringstream ss;
    ...
    case 7:
      switch(dim){
        case 0:
          CPUNaiveSIMDCenterDeriv7p_x(u_,u2_,nx_,ny_,nz_);
          break;
        case 1:
          CPUNaiveSIMDCenterDeriv7p_y(u_,u2_,nx_,ny_,nz_);
          break;
        case 2:
          CPUNaiveSIMDCenterDeriv7p_y(u_,u2_,nx_,ny_,nz_);
          break;
        case 3:
          CPUNaiveSIMDCenterDeriv7p_x(u_,u2_,nx_,ny_,nz_);
          CPUNaiveSIMDCenterDeriv7p_y(u_,u2_,nx_,ny_,nz_);
          CPUNaiveSIMDCenterDeriv7p_z(u_,u2_,nx_,ny_,nz_);
          break;
        default:
          std::stringstream ss;
          ss  << "dim '"<<dim<<"' unsupported!";
